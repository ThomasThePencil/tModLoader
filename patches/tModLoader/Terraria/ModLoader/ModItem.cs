...
namespace Terraria.ModLoader
{
	...
	public class ModItem:ModTexturedType
	{
		...
		/// <summary>
		/// Allows you to temporarily modify this weapon's knockback based on player buffs, player equipment, other players, etc. This is useful for making subclasses of damage (for example, Shroomite armor set boosts).
		/// </summary>
		/// <param name="player">The player using the item</param>
		...
		public virtual void GetWeaponKnockback(Player player, ref Modifier knockback) {
		}
